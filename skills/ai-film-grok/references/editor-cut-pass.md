...
### 0c. 性交冲击力标竿（Intercourse Impact · 2026-07-21）

用户要「性交 / 办事画面 / 冲击最大化 / 尺度太小」时 **必填**：

- [ ] `coitus_grammar` 六拍覆盖：ENTRY · UNION · RHYTHM · LOCK · FINISH · HOOK  
- [ ] **Mute Frame Test**：act 静帧静音可读「正在结合」；拥抱/并排坐 = fail  
- [ ] 冲击七刀 ≥5（骨盆可读、衣着办事层、景别下压、节奏蒙太奇、动静反差、声画同词、双轨）  
- [ ] 审核软化时 B 轨+insert 补偿，禁整片退回暧昧  
- [ ] 详课：[lessons-2026-07-21-intercourse-impact-benchmark.md](lessons-2026-07-21-intercourse-impact-benchmark.md)  
