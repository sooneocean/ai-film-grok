...
| 本地 MiniMax H3 | **实验 pilot**：`comfy-h3` T2V/I2V（R2V 待权重）；`hybrid_h3` 时 restricted soft-lock H3；**不**静默 bulk；`h3.max_duration_sec≤8` · draft mp0.2；成片默认 `strip_native_use_tts_bgm`；Wan 2.2 本地 I2V 仍退役 |
