...
- **Fill-Idle（2.37.4）**：Grok 铺 soft；restricted 主轨 H3；P0→P1→P2 空闲挑战 Grok；PK=shortlist+人 promote；final 不等 P2 填完。见 [fill-idle memory](../../memory/2026-08-04-h3-fill-idle-challenge.md)。
