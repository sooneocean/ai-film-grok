...
- **Fill-Idle（2.38.0 αβγ）**：`run-next --max N`（P2=pilot·换模 free-memory）；`pk-compare` 复合分；`evidence` 记账；dual 粘连/够动可停盲 R2V；`ship-prep`→人 promote。见 [fill-idle memory](../../memory/2026-08-04-h3-fill-idle-challenge.md)。
