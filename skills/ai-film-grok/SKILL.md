...
7. **供应商**：I2V=`grok_primary`；恢复路径才进 FRW，默认 `seedance-2-fast-i2v`。FRW pilot 可全 advertised＋callable 候选 A/B，production 仅人审 champion＋challenger（[frw-ab](references/frw-ab-workflow.md)）；不改 primary、禁静默 bulk。
