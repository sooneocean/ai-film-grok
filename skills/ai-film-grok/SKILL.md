...
19. **抗重复**：[shot-variety](references/lessons-2026-07-29-shot-variety-anti-boring.md) — 禁复制 motion；景别真变；contact 可读。
20. **5090 独占**：[gpu-priority](references/lessons-2026-07-29-comfy-gpu-priority-pilot-i2v.md) — 一机一 owner；实验只限 pilot；文件数才算。
