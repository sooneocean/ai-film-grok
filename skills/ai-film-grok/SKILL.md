...
7. **动作**：`grok_primary`=Grok→FRW API→LTX 2.3（对白锁 LTX）。**`hybrid_h3`**：云 bulk=Grok；restricted/肉戏→本地 H3（verified；**bulk 要 pilot 批**）。H3 最大化：I2V 锁脸 · R2V 高动 · T2V 无脸；续镜=末帧→I2V。禁 Seedance/Wan。[h3-max](references/lessons-2026-08-04-h3-max-effect.md)·[矩阵](references/weapon-lane-matrix.md)
