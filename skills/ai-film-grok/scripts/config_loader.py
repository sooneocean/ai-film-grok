...
_ENV_HELP: dict[str, str] = {
    ...
    "AIFILM_I2V_PROFILE": "I2V operating profile: grok_primary | ltx23_primary | seedance_first",
...
_DEFAULT_EXAMPLES: dict[str, tuple[str, str]] = {
    ...
    "AIFILM_I2V_PROFILE": ("grok_primary", "grok_primary | ltx23_primary | seedance_first"),
