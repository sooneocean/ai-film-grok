...
class PilotApproveTests(unittest.TestCase):
    ...
    def test_user_phrase_markers(self) -> None:
        ...
        self.assertTrue(user_phrase_is_approval("批准 Qwen 为 champion，Flux 为 challenger"))
        self.assertTrue(user_phrase_is_approval("核准这轮 pilot"))
        ...
        self.assertFalse(user_phrase_is_approval("尚未核准"))
        self.assertFalse(user_phrase_is_approval("未批准"))
        self.assertFalse(user_phrase_is_approval("不要批准"))
        self.assertFalse(user_phrase_is_approval("不能核准"))
        self.assertFalse(user_phrase_is_approval("拒绝批准"))
        self.assertFalse(user_phrase_is_approval("没有批准"))
        self.assertFalse(user_phrase_is_approval("没批准"))
        self.assertFalse(user_phrase_is_approval("没核准"))
        self.assertFalse(user_phrase_is_approval("还没批准"))
        self.assertFalse(user_phrase_is_approval("不会批准"))
        self.assertFalse(user_phrase_is_approval("绝不核准"))
        self.assertFalse(user_phrase_is_approval("请勿批准"))
        self.assertFalse(user_phrase_is_approval("别批准"))
        self.assertFalse(user_phrase_is_approval("取消批准"))
        self.assertFalse(user_phrase_is_approval("撤回批准"))
        self.assertFalse(user_phrase_is_approval("并非批准"))
        self.assertFalse(user_phrase_is_approval("未获批准"))
        self.assertFalse(user_phrase_is_approval("批准未通过"))
        self.assertFalse(user_phrase_is_approval("批准否"))
        self.assertFalse(user_phrase_is_approval("收回批准"))
        self.assertFalse(user_phrase_is_approval("批准作废"))
        self.assertFalse(user_phrase_is_approval("批准失败"))
        self.assertFalse(user_phrase_is_approval("驳回批准"))
        self.assertFalse(user_phrase_is_approval("批准吗"))
        self.assertFalse(user_phrase_is_approval("是否批准"))
        self.assertFalse(user_phrase_is_approval("可否核准"))
        self.assertFalse(user_phrase_is_approval("反对批准"))
        self.assertFalse(user_phrase_is_approval("谁批准"))
        self.assertFalse(user_phrase_is_approval("批准呢"))
        self.assertFalse(user_phrase_is_approval("批准失效"))
        self.assertFalse(user_phrase_is_approval("批准过期"))
        self.assertFalse(user_phrase_is_approval("批准待定"))
        self.assertFalse(user_phrase_is_approval("批准作罢"))
        self.assertFalse(user_phrase_is_approval("批准草案"))
        self.assertFalse(user_phrase_is_approval("批准存疑"))
        self.assertFalse(user_phrase_is_approval("批准写错了"))
        self.assertFalse(user_phrase_is_approval("批准是他写的"))
