...
7b. **多 agent 5090 禁抢闲占满（P0 · 2026-08-06）**：`free-first`≠until-empty 长驻；默认不挂排水/自动 supervisor；busy 零 submit → [memory](skills/ai-film-grok/memory/2026-08-06-multi-agent-gpu-no-hog.md) · hard-defaults。
