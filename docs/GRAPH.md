...
- `skills/ai-film-grok/tests/test_action_policy.py`
- `skills/ai-film-grok/tests/test_ad_process_optimization.py`
...
- `skills/ai-film-grok/tests/test_asset_picker.py`
- `skills/ai-film-grok/tests/test_asset_registry.py`
- `skills/ai-film-grok/tests/test_attestation_provenance.py`
...
- `skills/ai-film-grok/tests/test_audio_production.py`
...
- `skills/ai-film-grok/tests/test_autopilot.py`
- `skills/ai-film-grok/tests/test_axis_jump_gate.py`
- `skills/ai-film-grok/tests/test_benchmark.py`
- `skills/ai-film-grok/tests/test_bgm_anti_fatigue.py`
...
- `skills/ai-film-grok/tests/test_c5_json_io_single_entry.py`
- `skills/ai-film-grok/tests/test_c5_path_externalization.py`
- `skills/ai-film-grok/tests/test_c5_subprocess_timeout.py`
- `skills/ai-film-grok/tests/test_c6_lane_a_delete_scan.py`
- `skills/ai-film-grok/tests/test_c6_migrate_queue_empty.py`
...
- `skills/ai-film-grok/tests/test_caption_cjk_spacing.py`
- `skills/ai-film-grok/tests/test_caption_frame_audit.py`
- `skills/ai-film-grok/tests/test_caption_pixel_check.py`
...
- `skills/ai-film-grok/tests/test_chatterbox_local_tts.py`
- `skills/ai-film-grok/tests/test_checkout_drift.py`
- `skills/ai-film-grok/tests/test_checkpoint.py`
- `skills/ai-film-grok/tests/test_ci_roi_contract.py`
- `skills/ai-film-grok/tests/test_ci_typecheck_gate.py`
- `skills/ai-film-grok/tests/test_cinema_prompt.py`
- `skills/ai-film-grok/tests/test_cinematic_audit.py`
- `skills/ai-film-grok/tests/test_cinematic_color_grading.py`
- `skills/ai-film-grok/tests/test_cinematic_gate.py`
- `skills/ai-film-grok/tests/test_cli_audio_extract.py`
...
- `skills/ai-film-grok/tests/test_cli_pilot_extract.py`
...
- `skills/ai-film-grok/tests/test_closeout_plate_honesty.py`
- `skills/ai-film-grok/tests/test_cloud_media_download.py`
...
- `skills/ai-film-grok/tests/test_comfy_tunnel_ensure.py`
...
- `skills/ai-film-grok/tests/test_composition_anti_hijack.py`
- `skills/ai-film-grok/tests/test_composition_fill_wave3.py`
- `skills/ai-film-grok/tests/test_composition_rules.py`
- `skills/ai-film-grok/tests/test_console_projection.py`
- `skills/ai-film-grok/tests/test_content_channels.py`
- `skills/ai-film-grok/tests/test_continue_and_dp_optics.py`
- `skills/ai-film-grok/tests/test_continuity_chain.py`
- `skills/ai-film-grok/tests/test_continuity_programmatic.py`
- `skills/ai-film-grok/tests/test_core_constants.py`
- `skills/ai-film-grok/tests/test_core_emit.py`
- `skills/ai-film-grok/tests/test_core_film_io.py`
- `skills/ai-film-grok/tests/test_core_gates.py`
- `skills/ai-film-grok/tests/test_core_media_ops.py`
- `skills/ai-film-grok/tests/test_core_paths.py`
...
- `skills/ai-film-grok/tests/test_dialogue_benchmark.py`
- `skills/ai-film-grok/tests/test_dialogue_benchmark_queue.py`
...
- `skills/ai-film-grok/tests/test_dialogue_primary_chain.py`
- `skills/ai-film-grok/tests/test_dialogue_production_plan.py`
...
- `skills/ai-film-grok/tests/test_dialogue_wave2.py`
- `skills/ai-film-grok/tests/test_dialogue_workflow_hardening.py`
- `skills/ai-film-grok/tests/test_director_center.py`
...
- `skills/ai-film-grok/tests/test_duration_target_ship_native.py`
- `skills/ai-film-grok/tests/test_edit_director.py`
- `skills/ai-film-grok/tests/test_edit_edl_merge.py`
- `skills/ai-film-grok/tests/test_edit_policy.py`
- `skills/ai-film-grok/tests/test_edit_rhythm_gamma.py`
- `skills/ai-film-grok/tests/test_edit_strategy.py`
- `skills/ai-film-grok/tests/test_effect_roi_e1_e5.py`
- `skills/ai-film-grok/tests/test_elevenlabs_canary.py`
- `skills/ai-film-grok/tests/test_error_hierarchy.py`
- `skills/ai-film-grok/tests/test_error_internalization_e1_e4.py`
...
- `skills/ai-film-grok/tests/test_export_cues_phrase_split.py`
- `skills/ai-film-grok/tests/test_export_hotpath_contracts.py`
...
- `skills/ai-film-grok/tests/test_face_lock_triple_f2.py`
...
- `skills/ai-film-grok/tests/test_fill_idle_primary_classify.py`
- `skills/ai-film-grok/tests/test_fill_idle_run_next_ledger.py`
- `skills/ai-film-grok/tests/test_film_production_os_w1_w2.py`
- `skills/ai-film-grok/tests/test_film_production_os_w3_w4.py`
- `skills/ai-film-grok/tests/test_film_production_os_w5_w6.py`
- `skills/ai-film-grok/tests/test_film_production_os_w7.py`
...
- `skills/ai-film-grok/tests/test_final_render_defaults.py`
- `skills/ai-film-grok/tests/test_final_review_input.py`
- `skills/ai-film-grok/tests/test_final_stages.py`
- `skills/ai-film-grok/tests/test_final_stages_peel.py`
- `skills/ai-film-grok/tests/test_final_text_layer_defaults.py`
- `skills/ai-film-grok/tests/test_final_voice_normalize.py`
- `skills/ai-film-grok/tests/test_final_wave_d.py`
- `skills/ai-film-grok/tests/test_five_track.py`
...
- `skills/ai-film-grok/tests/test_frw_ab.py`
- `skills/ai-film-grok/tests/test_frw_degrade_docs.py`
- `skills/ai-film-grok/tests/test_frw_dispatch.py`
- `skills/ai-film-grok/tests/test_frw_rate_limit.py`
- `skills/ai-film-grok/tests/test_frw_subprocess_contract.py`
- `skills/ai-film-grok/tests/test_frw_upload.py`
- `skills/ai-film-grok/tests/test_gate_auto.py`
- `skills/ai-film-grok/tests/test_gate_fail_closed.py`
- `skills/ai-film-grok/tests/test_gates_fail_closed.py`
...
- `skills/ai-film-grok/tests/test_golden_suite.py`
...
- `skills/ai-film-grok/tests/test_h3_mode_override_e5.py`
...
- `skills/ai-film-grok/tests/test_heat_plot_driven.py`
- `skills/ai-film-grok/tests/test_heat_spice_undefined.py`
- `skills/ai-film-grok/tests/test_higgs_performance_adapter.py`
- `skills/ai-film-grok/tests/test_hybrid_h3_lanes.py`
...
- `skills/ai-film-grok/tests/test_input_fidelity.py`
- `skills/ai-film-grok/tests/test_intake.py`
- `skills/ai-film-grok/tests/test_intake_review.py`
- `skills/ai-film-grok/tests/test_interactive_orchestration.py`
- `skills/ai-film-grok/tests/test_iron_i1_fail_closed.py`
- `skills/ai-film-grok/tests/test_iron_i2_anatomy_speaker.py`
- `skills/ai-film-grok/tests/test_iron_i2_closeout_rest.py`
- `skills/ai-film-grok/tests/test_jcut_lcut_editing.py`
- `skills/ai-film-grok/tests/test_kokoro_local_tts.py`
- `skills/ai-film-grok/tests/test_launchers.py`
- `skills/ai-film-grok/tests/test_lipsync_frozen.py`
- `skills/ai-film-grok/tests/test_local_llm.py`
- `skills/ai-film-grok/tests/test_local_omni_review.py`
- `skills/ai-film-grok/tests/test_lock_style_samefile.py`
- `skills/ai-film-grok/tests/test_logger.py`
- `skills/ai-film-grok/tests/test_logger_plain.py`
- `skills/ai-film-grok/tests/test_longform.py`
- `skills/ai-film-grok/tests/test_loudnorm_policy.py`
- `skills/ai-film-grok/tests/test_ltx23_audio_canary.py`
...
- `skills/ai-film-grok/tests/test_motion_core_integrate_a.py`
- `skills/ai-film-grok/tests/test_motion_core_p1.py`
...
- `skills/ai-film-grok/tests/test_narrative_rebind.py`
- `skills/ai-film-grok/tests/test_native_audio_mix.py`
- `skills/ai-film-grok/tests/test_native_text_gate.py`
- `skills/ai-film-grok/tests/test_neural_motion_qa.py`
- `skills/ai-film-grok/tests/test_next_actions.py`
- `skills/ai-film-grok/tests/test_nutrient_n1.py`
- `skills/ai-film-grok/tests/test_onboarding.py`
- `skills/ai-film-grok/tests/test_onboarding_persist.py`
- `skills/ai-film-grok/tests/test_onboarding_planner.py`
- `skills/ai-film-grok/tests/test_openops_receipt.py`
- `skills/ai-film-grok/tests/test_opt2_edge_queue_framing.py`
- `skills/ai-film-grok/tests/test_opt_round_a1_cinematic_post.py`
- `skills/ai-film-grok/tests/test_opt_round_a1_gates2.py`
- `skills/ai-film-grok/tests/test_opt_round_a1_heat_final_receipt.py`
- `skills/ai-film-grok/tests/test_opt_round_a1_iron.py`
- `skills/ai-film-grok/tests/test_opt_round_a1_preflight_pass.py`
- `skills/ai-film-grok/tests/test_opt_round_a1_state_index.py`
- `skills/ai-film-grok/tests/test_optimization_program.py`
...
- `skills/ai-film-grok/tests/test_pgrep_no_source_match.py`
...
- `skills/ai-film-grok/tests/test_piper_local_tts.py`
- `skills/ai-film-grok/tests/test_plan_feedback_patterns.py`
...
- `skills/ai-film-grok/tests/test_post_caption_route.py`
- `skills/ai-film-grok/tests/test_post_p1_timeline_doctor.py`
- `skills/ai-film-grok/tests/test_post_plan.py`
- `skills/ai-film-grok/tests/test_post_quality.py`
- `skills/ai-film-grok/tests/test_post_route.py`
- `skills/ai-film-grok/tests/test_predictive_media_queue.py`
- `skills/ai-film-grok/tests/test_preflight.py`
- `skills/ai-film-grok/tests/test_preflight_harness_w3.py`
- `skills/ai-film-grok/tests/test_production_book.py`
- `skills/ai-film-grok/tests/test_production_chain.py`
...
- `skills/ai-film-grok/tests/test_production_truth.py`
...
- `skills/ai-film-grok/tests/test_project_state.py`
...
- `skills/ai-film-grok/tests/test_realesrgan_probe.py`
- `skills/ai-film-grok/tests/test_realesrgan_upscale.py`
- `skills/ai-film-grok/tests/test_register_motion_mean_gate.py`
- `skills/ai-film-grok/tests/test_render_core_helpers.py`
- `skills/ai-film-grok/tests/test_render_final_dimension.py`
- `skills/ai-film-grok/tests/test_render_watchdog.py`
...
- `skills/ai-film-grok/tests/test_review_pack.py`
- `skills/ai-film-grok/tests/test_review_ui.py`
- `skills/ai-film-grok/tests/test_rhythm.py`
- `skills/ai-film-grok/tests/test_roi_gates_face_doctor.py`
- `skills/ai-film-grok/tests/test_route_catalog.py`
- `skills/ai-film-grok/tests/test_run_next_soft_hog.py`
...
- `skills/ai-film-grok/tests/test_sfx_library.py`
- `skills/ai-film-grok/tests/test_ship_prep_throughput.py`
- `skills/ai-film-grok/tests/test_shortform_director.py`
- `skills/ai-film-grok/tests/test_shot_inventory.py`
- `skills/ai-film-grok/tests/test_shot_lane.py`
- `skills/ai-film-grok/tests/test_shot_lane_canary_wave6.py`
- `skills/ai-film-grok/tests/test_shot_package.py`
- `skills/ai-film-grok/tests/test_shot_planning.py`
...
- `skills/ai-film-grok/tests/test_skip_audit.py`
- `skills/ai-film-grok/tests/test_skip_canonical_truth.py`
...
- `skills/ai-film-grok/tests/test_speech_preview.py`
- `skills/ai-film-grok/tests/test_stable_audio_adapter.py`
- `skills/ai-film-grok/tests/test_stage_model.py`
- `skills/ai-film-grok/tests/test_stages_dialogue_stems.py`
- `skills/ai-film-grok/tests/test_stages_dual_mix.py`
- `skills/ai-film-grok/tests/test_stages_music_bed.py`
- `skills/ai-film-grok/tests/test_stages_picture_concat.py`
- `skills/ai-film-grok/tests/test_stages_subs.py`
- `skills/ai-film-grok/tests/test_stages_tts_stems_native.py`
- `skills/ai-film-grok/tests/test_stages_w18_orchestration.py`
- `skills/ai-film-grok/tests/test_stale_propagation.py`
- `skills/ai-film-grok/tests/test_still_challenge.py`
- `skills/ai-film-grok/tests/test_still_character_sheet_lint.py`
- `skills/ai-film-grok/tests/test_still_face_lock_bind_f3.py`
- `skills/ai-film-grok/tests/test_still_source.py`
- `skills/ai-film-grok/tests/test_still_uniqueness.py`
- `skills/ai-film-grok/tests/test_story_contract_and_quality.py`
...
- `skills/ai-film-grok/tests/test_sung_provider.py`
- `skills/ai-film-grok/tests/test_suse_final_iron.py`
...
- `skills/ai-film-grok/tests/test_transition_frame_closeout_t3.py`
...
- `skills/ai-film-grok/tests/test_tts_language_pingpong.py`
...
- `skills/ai-film-grok/tests/test_util_config_loader.py`
- `skills/ai-film-grok/tests/test_util_film_spec.py`
- `skills/ai-film-grok/tests/test_util_json_contract.py`
- `skills/ai-film-grok/tests/test_util_logger.py`
- `skills/ai-film-grok/tests/test_util_paths.py`
- `skills/ai-film-grok/tests/test_util_retry.py`
- `skills/ai-film-grok/tests/test_util_retry_json_source.py`
- `skills/ai-film-grok/tests/test_util_spine_helpers.py`
- `skills/ai-film-grok/tests/test_util_validators.py`
...
- `skills/ai-film-grok/tests/test_visual_text_audit.py`
...
- `skills/ai-film-grok/tests/test_wave4_variety_insert.py`
- `skills/ai-film-grok/tests/test_wave5_continue_env.py`
...
- `skills/ai-film-grok/tests/test_workflow_w8_autopilot.py`
...
- `tests/test_zero_narration_gate.py`
