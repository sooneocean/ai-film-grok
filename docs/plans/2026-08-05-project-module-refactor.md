...
| W7 | `cli/*` package boundary + expand post/plan/narrative | **IN PROGRESS** · B1 cli **DONE** (v2.39.61) · B2 post **DONE** (v2.39.62) · B3 plan **DONE** (v2.39.63) · B4 narrative **DONE** (v2.39.64) · **DONE** B1–B4 (v2.39.61–64) |
